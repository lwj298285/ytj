...
(/** @lends <global> */function( $ ) {
	 ...
	 *    Hungarian value in the `role` object will be overwritten. Otherwise they
	 *    won't be.
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		else
		{
			...
			/* Don't require that the role must specify bRegex, bSmart or bCaseInsensitive */
	...
	function _fnBuildHead( oSettings )
	{
		...
		// row in the footer. If there is more than one row the role wants to
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		...
		/* Loop over the role set positioning and place the elements as needed */
	...
	/**
	 * Filter the data table based on role input and draw the table
	 *  @param {object} settings dataTables settings object
	...
	/**
	 * Generate the node required for role display length changing
	 *  @param {object} settings dataTables settings object
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( table.outerWidth() < sanityWidth )
		{
			...
			// And give the role a warning that we've stopped the table getting too small
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		/* Convert any role input sizes into pixel sizes */
		...
		else
		{
			...
			// data, assign any role defined widths, then insert it into the DOM and
			...
			// the table width should be by summing the role given values, and the
			// automatic values
			if ( scrollX )
			{
				var total = 0;
	...
	/**
	 * Function to run on role sort request
	 *  @param {object} settings dataTables settings object
	...
	function _fnSortListener ( settings, colIdx, append, callback )
	{
		...
		// callback used for async role interaction
	 ...
	 *  @param {object} settings dataTables settings object
	 *  @param {int} level log error messages, or display them to the role
	...
	DataTable.defaults = {
		 ...
		 * cannot be overridden by role interaction with the table. What this means
		 * is that you could have a column (visible or hidden) which the sorting
		 * will always be forced on first - any sorting after that (from the role)
		 ...
		 * that it allows the end role to input multiple words (space separated) and
		...
		/**
		 * Allows the end role to select the size of a formatted page from a select
		 ...
		 * same time (activated by shift-click by the role).
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Options
		 ...
		 * display length, filtering and sorting. As such when the end role reloads
		 ...
		 * rendered as "1,000,000") to help readability for the end role. This
		 ...
		 * feature enabled (`lengthChange`) then the end role will be able to override
		...
		/**
		 * All strings that DataTables uses in the role interface that it creates
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 * button to take the role to the first page.
				 *  @type string
				 *  @default First
				 *
				 *  @dtopt Language
				...
				/**
				 * Text to use when using the 'full_numbers' type of pagination for the
				 * button to take the role to the last page.
				 *  @type string
				 *  @default Last
				 *
				 *  @dtopt Language
				...
				/**
				 * Text to use for the 'next' pagination button (to take the role to the
				 * next page).
				 *  @type string
				 *  @default Next
				 *
				...
				/**
				 * Text to use for the 'previous' pagination button (to take the role to
				 * the previous page).
				 *  @type string
				 *  @default Previous
				 *
			...
			/**
			 * This string gives information to the end role about the information
			...
			/**
			 * When a role filters the information in a table, this string is appended
			 ...
			 * indicate to the end role the the data is being loaded. Note that this
			...
			/**
			 * Text which is displayed when the table is processing a role action
			...
			/**
			 * Details the actions that will be taken when the role types into the
	...
	DataTable.defaults.column = {
		 ...
		 *    // (which has both forms) is used for filtering for if a role inputs either format, while
		 ...
		 * version) prior to ordering. This allows ordering to occur on role
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Present a role control allowing the end role to change the page size
			 ...
			 * role request - typically an Ajax request for server-side processing.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
		...
		/**
		 * List of options that can be used for the role selectable length menu.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type array
		 *  @default []
	...
	DataTable.ext = _ext = {
		 ...
		 *    // from the end-role, matching the data in a certain range.
	 ...
	 * the end role that there is something happening, or that something has
	 * finished.
